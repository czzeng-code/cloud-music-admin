...
public class MySqlGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://rm-m5ee476bu350735gjeo.mysql.rds.aliyuncs.com:3306/cloud_music?useUnicode=true&characterEncoding=utf8&useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai")
                .setUsername("root")
                .setPassword("XuNiit_#");
